...
surveyFields = [
    {
        ...
        'subtitle': ''' Small and mid-sized businesses miss about 6 2% of calls! Automating a text message back to missed-call dialers prevents
    ...
    },
    {
        ...
        'subtitle': ''' 9 out of 1 0 people want to use messaging to interact with businesses, and the average open rate of an SMS is 9 9 % ! It’s critical
    ...
    },
    {
        ...
        'subtitle': ''' SMS chat widgets allow website visitors to quickly initiate a text-message conversation but not be tethered to a websit'''
    },
    {
        'field_name1': 'yes_4',
        'field_name2': 'no_4',
    ...
    },
    {
        ...
        'subtitle': ''' Top-ranking local businesses have approximately 8 1 citations from top-level domains on average and search engines love to
see consistent data'''
    },
    {
        'field_name1': 'yes_6',
...
tions don't go unanswered'''
    ...
    },
    {
        'field_name1': 'yes_9',
        'field_name2': 'no_9',
        'title': '''Does the business have Text-2-Pay?''',
    ...
    },
    {
        ...
        'subtitle': '''3.3 Stars is the minimum rating customers accept '''
    },
    {
        'field_name1': 'yes_12',
        'field_name2': 'no_12',
